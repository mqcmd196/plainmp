...
#     Coordinates([0.6, +0.25, 0.25]).rotate(+np.pi * 0.5, "z"),
# ]
# eq_cst = stand_pose_const = jspec.crate_pose_const_from_coords(efnames, start_coords_list, [RotType.XYZW] * 4)

efnames = ["rleg_end_coords", "lleg_end_coords"]
start_coords_list = [Coordinates([0.0, -0.2, 0]), Coordinates([0.0, +0.2, 0])]
eq_cst = stand_pose_const = jspec.crate_pose_const_from_coords(
    efnames, start_coords_list, [RotType.RPY] * 2
)
